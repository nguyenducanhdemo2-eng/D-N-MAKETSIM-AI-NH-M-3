...
GROQ_API_KEY=os.getenv('GROQ_API_KEY','').strip(); GROQ_MODEL=os.getenv('GROQ_MODEL','llama-3.3-70b-versatile').strip(); GROQ_BASE_URL=os.getenv('GROQ_BASE_URL','https://api.groq.com/openai/v1').rstrip('/')
